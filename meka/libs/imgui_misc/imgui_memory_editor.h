...
// - v0.59 (2025/08/04): fixed GotoAddrAndHighlight() not working if OptShowOptions is disabled. removed use of SetScrollFromPosY() and GetCursorStartPos() (imgui/#1114). added configurable Lines count.
//
// TODO:
...
struct MemoryEditor
{
    ...
    void DrawContents(void* mem_data_void, size_t mem_size, size_t base_display_addr = 0x0000)
    {
        ...
        float child_height = (Lines >= 0) ? (Lines * ImGui::GetTextLineHeight()) : -footer_height;
        ImGui::BeginChild("##scrolling", ImVec2(-FLT_MIN, child_height), ImGuiChildFlags_None, ImGuiWindowFlags_NoMove | ImGuiWindowFlags_NoNav);
    ...
    void DrawOptionsLine(const Sizes& s, void* mem_data, size_t mem_size, size_t base_display_addr)
    {
        ...
        ImGui::SameLine();
        ImGui::Text(format_range, s.AddrDigitsCount, base_display_addr, s.AddrDigitsCount, base_display_addr + (mem_size != 0 ? mem_size - 1 : 0));
        ImGui::SameLine();
